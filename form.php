					...
					<div class="widget-content nopadding">
						...
						<form action="#" method="post" class="form-horizontal" enctype="multipart/form-data">
							<div class="control-group">
								<label class="control-label">Name : <?php if (isset($_POST["name"])) {echo $_POST["name"];}?></label>
								<div class="controls">
									<input type="text" class="span11" placeholder="Product name" name="name" /> *
								</div>
							</div>
							<div class="control-group">
								<label class="control-label">Choose a product type : <?php if (isset($_POST["type_id"])) {echo $_POST["type_id"];}?></label>
								<div class="controls">
									<select name="type_id">
							...
							<div class="control-group">
								<label class="control-label">Choose a manufacture : <?php if (isset($_POST["manu_id"])) {echo $_POST["manu_id"];}?></label>
								<div class="controls">
									<select name="manu_id">
								...
								<div class="control-group">
									<label class="control-label">Choose an image : <?php if (isset($_POST["fileUpload"])) {echo $_POST["fileUpload"];}?></label>
									<div class="controls">
										<input type="file" name="fileUpload" id="fileUpload">
									</div>
								</div>
								<div class="control-group">
									<label class="control-label"  > Description: <?php if (isset($_POST["description"])) {echo $_POST["description"];}?><br></label>
									<div class="controls">
										<textarea class="span11" placeholder="Description" name = "description"></textarea>
									</div>
									<div class="control-group">
										<label class="control-label">Price : <?php if (isset($_POST["price"])) {echo $_POST["price"];}?></label>
										<div class="controls">
